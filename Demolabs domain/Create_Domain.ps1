# Take some time to get the system stable
Write-Host "Sleeping for 60 Seconds for the System to settle.."
...
netsh interface ipv4 set dns name="Ethernet0" static 172.31.32.10
